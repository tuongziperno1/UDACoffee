...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://157.10.53.52/api/auth/login', { email, password });
                ...
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                        ...
                        <button aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-10 hover:bg-gray-100">
                            ...
                            <p className="text-base font-medium ml-4 text-gray-700">Tiếp tục với Google</p>
                        </button>
                        ...
                        <div>
                            ...
                            <input id="email" aria-labelledby="email" type="email" value={email}
                                onChange={(e) => setEmail(e.target.value)} className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" placeholder="vd: Tuong@gmail.com " />
                        </div>
                        <div className="mt-6 w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                <input value={password}
                                    onChange={(e) => setPassword(e.target.value)} id="myInput" type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        ...
                        <div className="mt-8">
                            <button role="button" onClick={handleLogin} className=" bg-primary/70 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">
                                Đăng nhập
                            </button>
                        </div>
                    </div>
                    <div className="xl:w-1/3 md:w-1/2 lg:ml-16 ml-8 md:mt-0 mt-6">
                        ...
                        <div className="flex items-start mt-8">
                            ...
                            <p className="sm:text-2xl text-xl leading-7 text-gray-600 pl-2.5">UDA Coffee thật xuất sắc khi ứng dụng công nghệ QR cho menu. Nhờ mã QR, khách hàng dễ dàng truy cập thực đơn một cách nhanh chóng và tiện lợi, giúp tiết kiệm thời gian và mang đến trải nghiệm hiện đại, thú vị.</p>
                        </div>
                        <div className="flex items-center pl-8 mt-10">
                            ...
                            <div className="ml-2">
                                <p className="text-sm font-medium leading-none text-gray-800">Chị B</p>
