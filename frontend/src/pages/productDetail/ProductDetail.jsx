...
const ProductDetail = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get("http://localhost:5000/api/product/"+ path);
                ...
                <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                    ...
                    <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                        ...
                        <div className=" flex flex-row justify-between  mt-5">
                            ...
                            <p className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-700 hover:underline hover:text-gray-800 duration-100 cursor-pointer">22 Đã xem</p>
                        </div>

                        <p className=" font-normal text-base leading-6 text-gray-600 mt-7">{product?.description}</p>
                        <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 ">{product?.price} đ</p>
                        ...
                        <div className="lg:mt-11 mt-10">
                            ...
                            <div className=" flex flex-row justify-between items-center mt-4">
                                <p className="font-medium text-base leading-4 text-gray-600">Mô tả chi tiết</p>
                    ...
                    {product && (
                        <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                            <div className=" w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                                <img src={product.imageUrl[0]} alt="Wooden Chair Previw" />
                            </div>
                            <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                                {product.imageUrl.length > 1 && product.imageUrl.map((i) => (
                                    <div className="bg-gray-100 flex justify-center items-center py-4">
                                        <img src={i} alt="Wooden chair - preview 1" />
                                    </div>
                                ))}
                            </div>
                        </div>
